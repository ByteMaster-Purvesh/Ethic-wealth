  ...
  const handleSubmit = async (e) => {
    ...
    if (validate()) {
      ...
      try {
        ...
        setBackendError(error.response?.data?.message || 'Something went wrong during registration.');
      } finally {
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-blue-100 w-full max-w-4xl overflow-hidden transform transition-all flex flex-col">
          ...
          <div className="w-full h-48 md:h-64 bg-blue-50 relative overflow-hidden hidden md:block">
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-start pl-12 md:pl-16 z-10">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-2 tracking-tight">Create an Account</h2>
              <p className="text-gray-600 text-sm md:text-base font-medium">Join us by creating your account.</p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-3xl font-bold text-gray-800 mb-2 tracking-tight md:hidden">Create an Account</h2>
              <p className="text-gray-500 text-sm mb-8 md:hidden">Join us by creating your account.</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`block w-full pl-10 pr-3 py-3 border ${errors.username ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : 'border-gray-200 focus:ring-blue-500 focus:border-blue-500'} rounded-lg focus:outline-none focus:ring-2 transition-colors bg-gray-50/50 text-gray-900 text-sm`}
                      placeholder="johndoe"
                    />
                  </div>
                ...
                <button
                  ...
                  className="w-full flex justify-center items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-4 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all shadow-md hover:shadow-lg disabled:opacity-70 mt-4 cursor-pointer"
                >
                  {isSubmitting ? (
          ...
          <div className="w-full md:w-1/2 p-8 md:p-12 bg-gray-50 flex flex-col justify-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h3 className="text-xl font-bold text-gray-800 mb-2">Alternative Sign Up</h3>
              <p className="text-gray-500 text-sm mb-8">Quickly create your account using other methods.</p>
